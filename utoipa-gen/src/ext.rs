...
// #[derive(PartialEq, Eq, PartialOrd, Ord#[cfg(feature = "rocket_extras")]
#[cfg_attr(feature = "debug", derive(Debug))]
pub enum MacroArg {
...
pub mod fn_arg {
    ...
    pub(super) fn with_parameter_in(
        ...
        let type_path = arg
            .ty
            .children
            .expect("FnArg2 TypeTreeValue expected must have children")
            .into_iter()
            .next()
            .unwrap()
            .path;
    ...
    #[cfg(any(feature = "actix_extras", feature = "axum_extras"))]
    pub(super) fn into_params_actix(fn_arg: &FnArg) -> bool {
